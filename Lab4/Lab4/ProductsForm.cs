...
namespace Lab3
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            else MessageBox.Show("Коллекция записей пуста!", "Сохранения результатов");
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            else MessageBox.Show("Читать нечего!", "Чтение результатов");
        }
        ...
        private void оТовареToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                string name = dataGridView1.Rows[dataGridView1.RowCount - 1].Cells["nameProd"].Value.ToString();
